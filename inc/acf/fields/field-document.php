 ...
 */
function govwind_register_post_type_fields_document_upload()
{
	...
	foreach ($post_types as $key => $post_type) {
		...
		if (
			isset($post_type->allow_document_upload) &&
			$post_type->allow_document_upload == "1"
		) {
			...
			acf_add_local_field([
				...
				"max_size" => "20",
				"mime_types" =>
					"pdf,doc,docx,rtf,odt,fodt,txt,xls,xlsx,ods,fods,ppt,pptx",
			]);
...
add_action("acf/init", "govwind_register_post_type_fields_document_upload");
