 ...
 *
 */
function govwind_register_post_type_fields_summary()
{
	...
	foreach ($post_types as $key => $post_type) {
		if (
			isset($post_type->post_summary) &&
			$post_type->post_summary == "1"
		) {
			...
			acf_add_local_field([
				...
				"instructions" =>
					"Summary is used throughout the site and on this page",
				"required" => 0,
				"conditional_logic" => 0,
				"wrapper" => [
					"width" => "",
...
add_action("acf/init", "govwind_register_post_type_fields_summary");
