<?php
/**
 * Title: Icon Grid with CTA
 * Slug: govwind/icon-grid-cta
 * Categories: features
...
<!-- wp:group {"metadata":{"categories":["features"],"patternName":"govwind/icon-grid-cta","name":"Icon Grid with CTA"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			...
			<h2 class="wp-block-heading alignwide">CTA Grid title</h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			...
			<p class="!max-w-none">We deliver a range of services designed to support individuals, communities, and public sector organisations.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
