...
<footer class="wp-block-group col-start-2 my-3 flex justify-between flex-col sm:flex-row has-luminous-vivid-amber-color has-black-background-color has-text-color has-background has-link-color"><!-- wp:heading {"className":"sr-only"} -->
