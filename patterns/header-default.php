...
<div class="wp-block-group alignfull is-style-default has-header-text-color has-header-bg-background-color has-text-color has-background has-link-color">
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group"><!-- wp:search {"label":"Search this site","showLabel":false,"width":320,"widthUnit":"px","buttonText":"Search","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"layout":{"selfStretch":"fit","flexSize":null}}} /-->

			<!-- wp:navigation {"openSubmenusOnClick":true,"overlayMenu":"always","icon":"menu","className":"is-style-detached wb-mobile-only","style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"flex","justifyContent":"left"}} /-->

			<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|40","left":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
				<!-- wp:group {"style":{"border":{"left":{"color":"var:preset|color|greyscale-B","style":"solid","width":"1px"},"right":{"color":"var:preset|color|greyscale-B","style":"solid","width":"1px"},"top":[],"bottom":[]},"spacing":{"blockGap":"0","padding":{"right":"0","left":"0"},"margin":{"top":"0","bottom":"0"}},"layout":{"selfStretch":"fixed","flexSize":""}},"layout":{"type":"constrained"}} -->
	...
	<!-- wp:navigation {"openSubmenusOnClick":true,"overlayMenu":"never","className":"is-style-drawer wb-desktop-only","style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"flex","justifyContent":"left"}} /--></div>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
