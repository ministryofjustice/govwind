 ...
 */
?>
<!-- wp:group {"align":"full","style":{"background":{"backgroundImage":{"url":"<?php gw_placeholder_image(
	$w = 1200,
	$h = 400,
...
<div class="wp-block-group alignfull wb-md-desktop-only-bg py-0 md:py-16" style="margin-top:var(--wp--preset--spacing--6);margin-bottom:var(--wp--preset--spacing--6)"><!-- wp:columns -->
