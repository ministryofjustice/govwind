...
?>
<!-- wp:group {"align":"full","style":{"background":{"backgroundImage":{"url":"<?php wb_placeholder_image($w = 1200,$h = 400) ?>","id":506,"source":"file","title":"fe8054bbe91334dcf6fbb63b995af58ad579a2cf"},"backgroundSize":"cover","backgroundPosition":"50% 50%","backgroundAttachment":"scroll"}},"layout":{"type":"constrained"}} -->
...
<figure class="wp-block-image size-large has-custom-border md:hidden"><img src="<?php wb_placeholder_image($w = 600,$h = 300) ?>" alt="Hero banner placeholder image" class="wp-image-506" style="border-top-left-radius:0px;border-top-right-radius:0px;border-bottom-left-radius:0px;border-bottom-right-radius:0px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
