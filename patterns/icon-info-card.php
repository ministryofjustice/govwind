...
<div class="wp-block-group has-background-secondary-background-color has-background" style="min-height:100px;padding-top:2rem;padding-right:2rem;padding-bottom:2rem;padding-left:2rem">
    ...
    <figure class="wp-block-image size-large is-resized is-style-default" style="margin-bottom:var(--wp--preset--spacing--50)"><img src="<?php wb_placeholder_image(96, 96); ?>" alt="Placeholder image" style="object-fit:contain;width:48px;height:48px" /></figure>
    <!-- /wp:image -->

    <!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"0"}}},"fontSize":"base","placeholder":"Add your heading here."} -->
    <h3 class="wp-block-heading has-base-font-size" style="margin-top:0"></h3>
    <!-- /wp:heading -->

    <!-- wp:paragraph {"style":{"typography":{"fontSize":"16px"}},"placeholder":"Add your text here."} -->
