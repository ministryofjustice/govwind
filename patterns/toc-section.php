...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Heading Two', 'govwind' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Heading Three', 'govwind' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Heading Four', 'govwind' ); ?></h2>
<!-- /wp:heading -->
